...
const hci_command_table_type hci_command_table[163] = {
  /* hci_disconnect */
...
{
  /* Input params */
  hci_le_set_privacy_mode_cp0 *cp0 = (hci_le_set_privacy_mode_cp0 *)(buffer_in + 1 +(0));
...
{
  /* Input params */
  aci_test_tx_notification_start_cp0 *cp0 = (aci_test_tx_notification_start_cp0 *)(buffer_in + 1 +(0));
...
{
  /* Input params */
  aci_test_tx_write_command_start_cp0 *cp0 = (aci_test_tx_write_command_start_cp0 *)(buffer_in + 1 +(0));
...
{
  /* Input params */
  aci_test_rx_start_cp0 *cp0 = (aci_test_rx_start_cp0 *)(buffer_in + 1 +(0));
...
{
  /* Input params */
  aci_test_stop_cp0 *cp0 = (aci_test_stop_cp0 *)(buffer_in + 1 +(0));
                             ...
                             
{
  ...
  if(BURST_WriteReceived(Connection_Handle, Attr_Handle, Attr_Data_Length, Attr_Data))
    return;
                                 ...
                                 uint8_t Attribute_Value[])
{
  ...
  if(BURST_NotificationReceived(Connection_Handle, Attribute_Handle, Attribute_Value_Length, Attribute_Value))
    return;
