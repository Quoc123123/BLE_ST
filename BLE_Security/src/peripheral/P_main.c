...
* Version            : 1.1.0
* Date               : 22-June-2017
* Description        : Code demostrating BlueNRG-1,2 BLE security example on Peripheral device.
********************************************************************************
...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
      <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_Security\\MDK-ARM\\BlueNRG-1\\BLE_Security.uvprojx </tt> or
      <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_Security\\MDK-ARM\\BlueNRG-2\\BLE_Security.uvprojx </tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_Security\\EWARM\\BlueNRG-1\\BLE_Security.eww </tt> or
     <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_Security\\EWARM\\BlueNRG-2\\BLE_Security.eww </tt>
  -# Select desired configuration to build
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |   BLE disconnection  |   BLE disconnection  |   BLE disconnection  |   BLE disconnection  |   BLE disconnection  |   BLE disconnection  |    BLE disconnection   |    BLE disconnection   |    BLE disconnection   |    BLE disconnection   |    BLE disconnection   |    BLE disconnection   |   BLE disconnection  |   BLE disconnection  |   BLE disconnection  |   BLE disconnection  |   BLE disconnection  |   BLE disconnection  |    BLE disconnection   |    BLE disconnection   |    BLE disconnection   |    BLE disconnection   |    BLE disconnection   |    BLE disconnection   |
