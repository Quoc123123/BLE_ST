...
* \section KEIL_project KEIL project
  ...
  -# Open the KEIL project
     <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_HID_Peripheral\\MDK-ARM\\BlueNRG-1\\HID_Peripheral.uvprojx </tt> or
     <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_HID_Peripheral\\MDK-ARM\\BlueNRG-2\\HID_Peripheral.uvprojx </tt>
...
* \section IAR_project IAR project
  ...
  -# Open the IAR project
     <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_HID_Peripheral\\EWARM\\BlueNRG-1\\HID_Peripheral.eww </tt> or
     <tt> C:\Users\{username}\ST\BlueNRG-1_2 DK x.x.x\\Project\\BLE_Examples\\BLE_HID_Peripheral\\EWARM\\BlueNRG-2\\HID_Peripheral.eww </tt>
  -# Select desired configuration to build
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|      PUSH1     |      Not Used      |      Not Used      |      Not Used      |      Not Used      |      Not Used      |      Not Used      |  Left mouse button and exit from deep sleep  |  Left mouse button and exit from deep sleep  |  Left mouse button and exit from deep sleep  |  Left mouse button and exit from deep sleep  |  Left mouse button and exit from deep sleep  |  Left mouse button and exit from deep sleep  |
|      PUSH2     |      Not Used      |      Not Used      |      Not Used      |      Not Used      |      Not Used      |      Not Used      |              Right mouse button              |              Right mouse button              |              Right mouse button              |              Right mouse button              |              Right mouse button              |              Right mouse button              |
